...
vc_map(array(
	'name' => esc_html__('Blog Grid', 'pintu'),
	'base' => 'bt_blog_grid',
	...
	'params' => array(
		array(
			...
			'value' => array(
				esc_html__('Auto', 'pintu') => 'bt-grid-auto',
				esc_html__('Fixed Row', 'pintu') => 'bt-grid-fixed',
				esc_html__('Masonry', 'pintu') => 'bt-grid-masonry'
			),
			'admin_label' => true,
		...
		array (
			...
			'description' => esc_html__('Note: By default, all your posts will be displayed. If you want to narrow output, select category(s) above. Only selected categories will be displayed.', 'pintu')
		),
		array(
			'type' => 'textfield',
		...
		array(
			...
			'value' => array(
				...
				esc_html__('Layout List 1', 'pintu') => 'layout-list1',
				esc_html__('Layout List 2', 'pintu') => 'layout-list2'
			),
			'admin_label' => true,
		...
		array(
			'type' => 'checkbox',
			'heading' => esc_html__('Zigzag', 'pintu'),
			'param_name' => 'zigzag',
			'value' => '',
			'dependency' => array(
				'element'=>'layout',
			...
			'group' => esc_html__('Item Setting', 'pintu'),
			'description' => esc_html__('Zigzag items display in this element.', 'pintu')
		),
		array(
			'type' => 'dropdown',
			'heading' => esc_html__('Media Type', 'pintu'),
			'param_name' => 'media_type',
			'value' => array(
				esc_html__('Simple', 'pintu') => 'simple',
				esc_html__('Multi', 'pintu') => 'multi'
			),
			'dependency' => array(
				'element'=>'layout',
			...
			'group' => esc_html__('Item Setting', 'pintu'),
			'description' => esc_html__('Select media type of items display in this element.', 'pintu')
		),
		array(
			'type' => 'checkbox',
			'heading' => esc_html__('Multi Media', 'pintu'),
			'param_name' => 'multi_media',
			'value' => array(
				esc_html__('Standard', 'pintu') => 'standard',
				esc_html__('Video', 'pintu') => 'video',
				esc_html__('Audio', 'pintu') => 'audio',
				esc_html__('Quote', 'pintu') => 'quote',
				esc_html__('Link', 'pintu') => 'link',
				esc_html__('Gallery', 'pintu') => 'gallery'
			),
			...
			'group' => esc_html__('Item Setting', 'pintu'),
			'description' => esc_html__('Select multi media type of items display in this element.', 'pintu')
		),
		array(
			'type' => 'textfield',
