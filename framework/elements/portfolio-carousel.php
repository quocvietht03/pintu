...
vc_map(array(
	'name' => esc_html__('Portfolio Carousel', 'pintu'),
    ...
    'params' => array(
		...
		array(
			'type' => 'dropdown',
			'heading' => esc_html__('Nav & Dots Style', 'pintu'),
			'param_name' => 'nav_dots',
			'value' => array(
				esc_html__('Default', 'pintu') => 'nav-dots-default',
				esc_html__('Style 1', 'pintu') => 'nav-dots-style1'
			),
			'group' => esc_html__('Owl Setting', 'pintu'),
			'description' => esc_html__('Select nav and dots style display in this element.', 'pintu')
		),
		array(
			'type' => 'dropdown',
