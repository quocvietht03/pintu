...
<div class="bt-item <?php echo esc_attr($active_class); ?>">
	<div class="bt-thumb">
		<?php
	...
	<div class="bt-content">
		...
		<?php
			...
			if($readmore_text) echo '<a class="bt-readmore" href="'.get_the_permalink().'"><i class="fa fa-caret-right"></i> '.$readmore_text.'</a>';
		?>
	</div>
</div>
