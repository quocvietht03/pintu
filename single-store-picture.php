...
$fullwidth = isset($pintu_options['single_store_picture_fullwidth'])&&$pintu_options['single_store_picture_fullwidth'] ? 'fullwidth': 'container';
$sidebar_width = (int) isset($pintu_options['single_store_picture_sidebar_width']) ?  $pintu_options['single_store_picture_sidebar_width']: 3;
...
$single_store_picture_titlebar = isset($pintu_options['single_store_picture_titlebar']) ? $pintu_options['single_store_picture_titlebar']: true;
if($single_store_picture_titlebar) pintu_titlebar();
?>
