...
$fullwidth = isset($pintu_options['single_team_fullwidth'])&&$pintu_options['single_team_fullwidth'] ? 'fullwidth': 'container';
$sidebar_width = (int) isset($pintu_options['single_team_sidebar_width']) ?  $pintu_options['single_team_sidebar_width']: 3;
...
$single_team_titlebar = isset($pintu_options['single_team_titlebar']) ? $pintu_options['single_team_titlebar']: true;
if($single_team_titlebar) pintu_titlebar();
?>
