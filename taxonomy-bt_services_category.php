...
$fullwidth = isset($pintu_options['services_fullwidth'])&&$pintu_options['services_fullwidth'] ? 'fullwidth': 'container';
$sidebar_width = (int) isset($pintu_options['services_sidebar_width']) ?  $pintu_options['services_sidebar_width']: 3;
...
$services_titlebar = isset($pintu_options['services_titlebar']) ? $pintu_options['services_titlebar']: true;
if($services_titlebar) pintu_titlebar();
?>
